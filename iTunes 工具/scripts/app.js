...
function showActions(index) {
  ...
  const ACTIONS = {
    ...
    COPY_APP_STORE_LINK: $l10n("COPY_APP_STORE_LINK"),
  ...
  if (entity.code.match(/software|iPadSoftware|macSoftware/)) {
    items = [ACTIONS.GET_ICON, ACTIONS.GET_SCREENSHOTS, ACTIONS.SHOW_DETAILS, ACTIONS.OPEN_APP_STORE, ACTIONS.COPY_APP_STORE_LINK, ACTIONS.TRANSLATE, ACTIONS.APP_PREVIEW]
  ...
  var handler = function(action) {
    ...
    } else if (action === ACTIONS.COPY_APP_STORE_LINK) {
      helper.copyAppStoreLink(country, item)
